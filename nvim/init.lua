...
do
  ...
  vim.list_extend(ensure_installed, {
    'clang-format', -- C/C++ formatting via <leader>f
...
do
  ...
  --
  -- require 'kickstart.plugins.debug' -- needs a debug adapter (e.g. codelldb), see file comments
  ...
  require 'kickstart.plugins.neo-tree' -- file explorer (press `\`)
